...
export default function Episode({episodeId, characters, episode} : any) {
 ...
 return (
        <PageOfEpisode>
            ...
            <Wrapper>
                <Button onClick={ () => goToPageEpisodes() } style = {{height : '55px'}}>Вернуться к Эпизодам</Button>
...
export async function getServerSideProps(ctx : any) {
    ...
    const episode = (await axios.get(`https://rickandmortyapi.com/api/episode/${episodeId}`)).data
    let characters = ''
